...
export function Figure({
  ...
  const frameClass =
    frame === "none"
      ? ""
      : frame === "card"
      ? "rounded-2xl border border-(--project-border,var(--border)) bg-white/80 p-2 backdrop-blur-sm"
      : "rounded-2xl border border-(--project-border,var(--border)) bg-white/60 backdrop-blur-sm"
